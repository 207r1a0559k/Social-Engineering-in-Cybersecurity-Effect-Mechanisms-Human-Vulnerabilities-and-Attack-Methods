...
--
-- Host: localhost
-- Generation Time: Jan 09, 2022 at 11:30 AM
...
--
-- Database: `social_engineering_in_cyber_security`
--
CREATE DATABASE IF NOT EXISTS `social_engineering_in_cyber_security` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `social_engineering_in_cyber_security`;
...
(1, 'Mahesh', 'Mahesh123@gmail.com', 'Mahesh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'bangalore'),
(3, 'Mohan', 'Mohan123@gmail.com', 'Mohan', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyber_security_attack_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyber_security_attack_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Victims` varchar(300) NOT NULL,
  `Sponsor` varchar(300) NOT NULL,
  `Category` varchar(300) NOT NULL,
  `Sources_Of_Attack` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Dumping data for table `remote_user_cyber_security_attack_prediction`
--

INSERT INTO `remote_user_cyber_security_attack_prediction` (`id`, `Title`, `Date`, `Affiliations`, `Description`, `Response`, `Victims`, `Sponsor`, `Category`, `Sources_Of_Attack`, `Prediction`) VALUES
(1, 'Attack on Austrian foreign ministry', '2/13/2020', 'Turla', 'The suspected Russian hackers conducted a weeks-long attack on Austriaâ€™s foreign ministry.', 'Confirmation   https://www.theregister.co.uk/2020/02/14/austria_foreign_ministry_hack_turla_group_allegs/', 'Austrian Foreign Ministry', 'Russian Federation', 'Government', 'https://www.theregister.co.uk/2020/02/14/austria_foreign_ministry_hack_turla_group_allegs/', 'Espionage'),
(2, 'Attack on Austrian foreign ministry', '2/13/2020', 'Turla', 'The suspected Russian hackers conducted a weeks-long attack on Austriaâ€™s foreign ministry.', 'Confirmation   https://www.theregister.co.uk/2020/02/14/austria_foreign_ministry_hack_turla_group_allegs/', 'Austrian Foreign Ministry', 'Russian Federation', 'Government', 'https://www.theregister.co.uk/2020/02/14/austria_foreign_ministry_hack_turla_group_allegs/', 'Espionage'),
(3, 'Targeting of Burisma', '1/13/2020', 'APT 28', 'The alleged Russian actors hacked Burisma, a Ukrainian gas company whose board Joe Bidenâ€™s son sat on. President Trump had previously pressed Ukraine to open an investigation into Biden and Burisma, which led to his impeachment.', 'Confirmation   https://www.ynet.co.il/article/rJrCqmAkw', 'Burisma', 'Saudi Arabia', 'Civil society', 'https://citizenlab.ca/2020/01/stopping-the-press-new-york-times-journalist-targeted-by-saudi-linked-pegasus-spyware-operator/', 'Espionage'),
(4, 'Targeting of Israeli water management facilities', '7/17/2020', 'Believed to be the work of the Iranian government.', 'Hackers targeted two water pumps in Galilee and Mateh Yehuda. No real-world effects were reported as a result of the hacking operation.Â Israel''s government stated that no data had been stolen.distributed numerous COVID-19â€“themed Android mobile apps to Arabic-speaking users.', 'Confirmation   https://www.ynet.co.il/article/rJrCqmAkw', 'Israel', 'Iran (Islamic Republic of)', 'Government', 'https://www.ynet.co.il/article/rJrCqmAkw', 'Vulnerabilities'),
(5, 'Storm Cloud', '3/31/2020', 'NOTE: Some Moonlight Maze tooling has also been referred to as â€œStorm Cloud.â€ There is no known connection.', 'Performed highly targeted watering-hole attacks on visitors to Tibetan websites.', 'Hack Back   https://www.timesofisrael.com/cyberattack-on-port-suggests-israeli-tit-for-tat-strategy-shows-iran-vulnerable/\r\n', 'Japanese, Russian, and South Korean civil society, private sector, and government entities.', 'China', 'Private sector\r\n', 'https://www.volexity.com/blog/2020/03/31/storm-cloud-unleashed-tibetan-community-focus-of-highly-targeted-fake-flash-campaign/', 'Vulnerabilities'),
(6, 'Attack on forum of Hong Kong protesters', '12-04-2019', 'Chinese government', 'Chinaâ€™s government used its â€œGreat Cannonâ€ distributed denial of service (DDOS) system for the first time in two years to attack a forum where Hong Kong residents organized protests.', 'Hong Kong protesters', 'China', 'Civil society, Private sector', 'Government', 'https://www.zdnet.com/article/china-resurrects-great-cannon-for-ddos-attacks-on-hong-kong-forum/', 'Denial of service'),
(7, 'Indictment of officials from the Mabna Institute', '3/28/2018', 'Believed to be the work of TempTickÂ and Turla', 'The U.S. Department of Justice indicted nine officials from the Mabna Insititute, an Iranian company alleged to have conducted state-sponsored cyber operations on behalf of the Iranian Revolutionary Guards. They are alleged to have compromised the networks of over 144 U.S. universities, 176 universi', 'Iran (Islamic Republic of)', 'Criminal charges   https://www.justice.gov/opa/pr/nine-iranians-charged-conducting-massive-cyber-theft-campaign-behalf-islamic-revolutionary', 'United States, United Nations, UNICEF, Australia, Canada, China, Denmark, Germany, Ireland, Israel, Italy, Japan, Malaysia, Netherlands, Norway, Poland, Singapore, Republic of Korea, Spain, Sweden, Switzerland, Turkey, United Kingdom', 'Government, Civil society', 'https://www.justice.gov/opa/pr/nine-iranians-charged-conducting-massive-cyber-theft-campaign-behalf-islamic-revolutionary', 'Espionage'),
(8, 'Compromise at Mitsubishi Heavy Industries', '9/19/2011', 'Possibly linked to the Nitro incident', 'A threat actor compromised Mitsubishi Heavy Industries, a Japanese defense contractor, targeting shipyards and research and development facilities.', 'Mitsubishi Heavy Industries', 'Possibly linked to the Nitro incident', 'China', 'Private sector', 'http://www.reuters.com/article/us-mitsubishiheavy-computer-idUSTRE78I0EL20110919', 'Espionage');
...
(51, 'Naive Bayes', '77.31958762886599'),
(52, 'SVM', '75.25773195876289'),
(53, 'Logistic Regression', '78.35051546391753'),
(54, 'Decision Tree Classifier', '68.04123711340206'),
(55, 'SGD Classifier', '74.22680412371135'),
(56, 'Random Forest Classifier', '77.31958762886599');
...
(28, 'Espionage', '62.5'),
(29, 'Vulnerabilities', '25.0'),
(30, 'Denial of service', '12.5');
